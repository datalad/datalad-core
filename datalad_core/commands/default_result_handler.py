...
class DefaultHandler(ResultHandler):
    """Standard DataLad command result handler
    ...
    def __call__(self, producer: Callable):
        """ """
        # book-tkeeping whether to raise an exception
    ...
    def want_custom_result_summary(self, mode: str) -> bool:  # noqa: ARG002
        """ """
        return False
    ...
    def keep_result(self, res) -> bool:  # noqa: ARG002
        """ """
        return True


__the_default_result_handler_class: type[ResultHandler] = DefaultHandler
